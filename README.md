# Modulus PHP Docker Build Image
...
``` text
$ docker pull onmodulus/docker-build-php:latest
$ docker run -v /host-folder:/mnt -p 80:8080 onmodulus/docker-build-php:latest build
```
